...
export const NursingPanel = ({ patients, onRefresh, currentUser }: NursingPanelProps) => {
  ...
  const renderServiceIsland = () => {
    ...
    return (
      <div className="bg-white dark:bg-slate-800 border-2 border-amber-500/50 px-8 py-6 rounded-[32px] flex items-center gap-4 shadow-xl group">
        ...
        <div>
          <h4 className="text-[10px] font-black uppercase tracking-widest opacity-60 text-black dark:text-white">Servicio</h4>
          <p className="text-sm font-black uppercase tracking-tighter text-amber-600">Limpieza & Té</p>
          <div className="flex flex-wrap gap-x-2 gap-y-0.5 mt-1">
            {staff.map((name, i) => (
              <span key={i} className="text-[11px] font-bold text-slate-600 dark:text-slate-400 whitespace-nowrap capitalize">
      ...
      {selectedFloor === 0 ? (
        ...
        <div className="space-y-12 overflow-x-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="bg-white dark:bg-slate-800 border-2 border-orange-500/20 px-10 py-6 rounded-[32px] flex items-center gap-4 shadow-xl group">
              ...
              <div>
                <h4 className="text-[10px] font-black uppercase tracking-widest opacity-60 text-black dark:text-white">Responsable</h4>
                <p className="text-sm font-black uppercase tracking-tighter text-orange-600">Doctor a cargo</p>
                <p className="text-[12px] font-black text-black dark:text-white leading-tight">{getDoctorName(1)}</p>
              </div>
            </div>

            <div className="bg-white dark:bg-slate-800 border-2 border-blue-500/20 px-4 md:px-6 py-5 rounded-[32px] flex items-center gap-4 md:gap-6 shadow-xl relative overflow-hidden group w-full md:w-auto max-w-full">
            ...
            <div className="min-w-[700px] lg:min-w-0">
              ...
              <div className="max-w-5xl mx-auto px-1 md:px-4">
                <div className="mb-6 md:mb-12">
                  ...
                  <div className="grid grid-cols-5 gap-3 md:gap-6 justify-center">
                ...
                <div className="grid grid-cols-5 gap-3 md:gap-6 items-start">
                  ...
                  <div className="col-span-3 flex items-center justify-center pt-8 md:pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="bg-orange-50/80 dark:bg-orange-500/10 border border-orange-200 dark:border-orange-500/30 px-10 py-6 rounded-[32px] flex items-center gap-4 backdrop-blur-md shadow-xl group">
              ...
              <div>
                <h4 className="text-[10px] font-black uppercase tracking-widest opacity-60 text-black dark:text-white">Responsable</h4>
                <p className="text-sm font-black uppercase tracking-tighter text-orange-600">Doctor a cargo</p>
                <p className="text-[12px] font-black text-black dark:text-white leading-tight">{getDoctorName(2)}</p>
              </div>
            </div>
              ...
              <div key={log.id} className="bg-[var(--bg-accent)]/50 border border-[var(--border-color)] p-5 rounded-3xl relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-[9px] font-bold opacity-30">
                    {new Date(log.timestamp).toLocaleTimeString('es-AR', { hour: '2-digit', minute: '2-digit', hour12: true })} hs
                  </span>
                </div>
